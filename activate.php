...
//		'site_socialsharing_shareemail' => 1,
        ...
        'post_backgrounds_enable'   =>  1,
        'post_backgrounds_max_length'  => 200,
        'post_backgrounds_scrollable'   =>  1,
        ...
        'peepsocom_connect_url_base' => 'www.peepso.com',
        'peepsocom_connect_use_dns_discovery' => 1,
        'peepsocom_connect_use_ssl_verify' => 1,
        'peepsocom_connect_timeout' => 10,
        'peepsocom_connect_upsell'=>1,

        'version_lock' => 3,

        'postbox_new_enabled' => 1,
        'postbox_inactive_post_type_shortcuts' => 4,
        'postbox_inactive_post_type_labels' => 1,
        'postbox_active_post_type_labels' => 2,
...
Thank you.",
            'email_new_user_no_password' => "Hello {userfullname}
...
This is your password for login: {userpassword}
...
{userfullname} ({userlogin}) has filed a report. Reason: {reason}

You can see the reported item here: {activityurl}
        ...
        $aRet = array(
            ...
            'notifications' => "
				CREATE TABLE notifications (
                    ...
                    not_processed_app_push TINYINT(1) SIGNED NOT NULL DEFAULT '-1',
                    not_url TEXT(256) NOT NULL DEFAULT '',
					PRIMARY KEY (not_id),
            ...
            'report' => "
				CREATE TABLE report (
					...
					rep_reason VARCHAR(256) NULL DEFAULT NULL,
					rep_desc TEXT NULL DEFAULT NULL,
					rep_module_id SMALLINT(5) UNSIGNED NOT NULL DEFAULT '1',
					rep_status TINYINT(1) UNSIGNED NOT NULL DEFAULT '0',
					rep_last_maintenance DATETIME NULL DEFAULT NULL,
					PRIMARY KEY (rep_id),
