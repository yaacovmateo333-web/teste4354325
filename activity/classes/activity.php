...
//				'type' => $type,
    ...
    public function replycomment(PeepSoAjaxResponse $resp) {
        ...
        if (PeepSo::check_permissions($owner_id, PeepSo::PERM_COMMENT, $user_id)) {
            ...
            $html = PeepSoTemplate::exec_template('activity', 'comment-reply', array('post_id' => $post_id, 'act_id' => $act_id, 'PeepSoActivity' => $this), TRUE);
...
//        if (PeepSo::check_permissions($owner_id, PeepSo::PERM_COMMENT, $user_id)) {
        PeepSoTemplate::exec_template('activity', 'comment-reply', array('post_id' => $post_id, 'act_id' => $act_id, 'PeepSoActivity' => $this), FALSE);
//        }
